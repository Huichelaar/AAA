...
def main():
  ...
  parser.add_argument('-i', default="script.txt", help='Input battle anim script. default is script.txt')
  args = parser.parse_args()

  if not os.path.isfile(args.i):
    print("ERROR: Couldn't find input file: \"" + args.i + "\".")
    exit()

  animName = args.i[:-4]
  scriptFile = open(args.i, "r")
